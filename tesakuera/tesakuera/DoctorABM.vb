...
Public Class DoctorABM
    ...
    Private Sub DoctorABM_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
#Region "Cargas Iniciales"
    Private Sub cargarVistaPrevia()
        ...
        SQL = "SELECT [Codigo],[Nombre] ,[CUIL]
      ,[Matricula],[Telefono],[Email]
  FROM [Oculus].[dbo].[Doctor]
"
...
#Region "ABM"
    Private Function AltaRegistro() As Boolean
      ...
      ,@Email" +
                    ...
                    cmd.Parameters.Add("@Matricula", SqlDbType.NVarChar, 50).Value = txtDireccion.Text
        ...
        Try
            ...
            Using conn As New SqlConnection(Connstr.cargarConexion)
                ...
                Using cmd As SqlCommand = conn.CreateCommand()
                    ...
                    conn.Open()
                    'indico que comando voy a ejecutar "ES UN TIPO DE CONSULTA SQL"
                    cmd.CommandText = "delete  FROM [Doctor] where [codigo]=@Codigo "
...
#Region "TEXT BOX"
    Private Sub txtFiltro_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtFiltro.KeyPress
        ...
        SQL = "SELECT [Codigo],[Nombre] ,[CUIL]
      ,[Matricula],[Telefono],[Email]
  FROM [Oculus].[dbo].[Doctor] where Nombre like '%" & txtFiltro.Text & "%'"
        'Armo una conexion al servidor
        Using conn As New SqlConnection(Connstr.cargarConexion)
            'creo la variable para conectar a los comandos sql
            Using cmd4 As SqlCommand = conn.CreateCommand()
