...
GO
-- Índice para búsquedas rápidas por el nombre de la provincia
CREATE INDEX idx_Provincia_nombre ON Provincia(provincia);
GO
CREATE Table localidades (
  Codigo int,
  CodigoProvincia int NOT NULL,
  localidad varchar(255) NOT NULL,
 constraint pk_Localidades PRIMARY KEY (Codigo),
 CONSTRAINT fk_Localidades_Provincia FOREIGN KEY (CodigoProvincia)
REFERENCES Provincia(Codigo)
)
GO
-- Índice para búsquedas rápidas por nombre de localidad
CREATE INDEX idx_Localidades_nombre ON localidades(localidad);
GO
-- Índice para búsquedas rápidas por CódigoProvincia
CREATE INDEX idx_Localidades_Provincia ON localidades(CodigoProvincia);
GO
...
INSERT INTO localidades (Codigo, CodigoProvincia, localidad) VALUES
(1, 1, '25 de Mayo'),
(2, 1, '3 de febrero'),
(3, 1, 'A. Alsina'),
